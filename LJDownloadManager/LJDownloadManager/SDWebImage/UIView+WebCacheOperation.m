...
// 如果现在要先设置a.png再设置p.png到一个视图上，这里存在一个覆盖问题（如果先下载的b，再下载的a,这里的下载都是异步的，那么很可能b会覆盖a，但是我们的目的是想将b设置到视图上，这显然没有达到我们的要求.......eg:cell中imageView的复用问题尤其经典），因此这里会先取消掉之前视图对象绑定的下载任务，用新的任务（operation）来进行绑定
